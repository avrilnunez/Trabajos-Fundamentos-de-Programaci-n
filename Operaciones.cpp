...
int main(){
	...
	int x=10,y=3;
	int z = 10;//Declara variable int con valor de 10
	int *diez = &z; //Declara puntero (int*) y le asigna el contenido de la dirección z
	cout<<x<<"+"<<y<<"="<<x+y<<"\n";//13
	cout<<x<<"-"<<y<<"="<<x-y<<"\n";//7
	cout<<x<<"*"<<y<<"="<<x*y<<"\n";//30
	cout<<x<<"/"<<y<<"="<<x/y<<"\n";//3
    ...
    cout << "La dirección de z almacenada en diez: " << diez <<endl;
    cout<<"El contenido en *dirz: "<<*diez<<endl;
    return 0;
	}
